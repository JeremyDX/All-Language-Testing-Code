...
public class ReadWriteBuffer
{
	...
	public String ConvertToString(int offset)
	{
		return new String(buffer, offset, capacity() - offset);
	}
	...
	public static ReadWriteBuffer read(String s) 
	{
		...
		try 
		{
			...
			System.err.println((new StringBuilder()).append("IO ERROR - Directory N/A: ")
			.append(file).append(", Length").append(length).append('\n').append(io.toString()).toString());
			io.printStackTrace();
		}
